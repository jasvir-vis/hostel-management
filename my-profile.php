...
$update = "UPDATE `student_profile` set first_name='$fname',last_name='$lname',dob='$dob',email='$email',mobile='$mobile'";
$up = mysqli_query($conn,$update);

if($up){
    echo "<script>alert('your data updated successffull')</script>";
}
else{
    echo "<script>alert('something error to update it')</script>";
        ...
        <div class="bg-white p-4 p-md-5 rounded shadow-sm">
          ...
          <form action="" method="post">
            <div class="row gy-3 gy-md-4 overflow-hidden">
                ...
                <input type="text" class="form-control" name="lname" placeholder="last name" value="<?php echo $row['last_name']; ?>"  required>
                </div>
                <div class="col-md-6">
                <label for="email" class="form-label">Date of birth <span class="text-danger">*</span></label>
                <input type="date" class="form-control" name="dob" placeholder="" value="<?php echo $row['dob']; ?>"  required>
                </div>
                <div class="col-md-6">
              ...
              <div class="col-12">
                ...
                <input type="email" class="form-control" name="email" id="email" value="<?php echo $row['email']; ?>"  placeholder="name@example.com" required>
              </div>
              <div class="col-12">
              <label for="email" class="form-label">Mobile<span class="text-danger">*</span></label>
                <input type="number" class="form-control" name="mobile" placeholder="Mobile" value="<?php echo $row['mobile']; ?>"  required>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <div class="d-grid">
                  <input class="btn btn-lg btn-primary" type="submit" name="update" value='update'/>
                </div>
              </div>
            </div>
          </form>
