...
<div class="bg-light py-3 py-md-5" id="print-content">
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
        <div class="bg-white p-4 p-md-5 rounded shadow-sm">
          ...
          $d = "SELECT * from book_hostel where email='{$_SESSION['mail']}'";
          $v = mysqli_query($conn,$d);
          while($row = mysqli_fetch_assoc($v)){
          ?>
           <div class="row">
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Registration Number :</span> <span class="text-secondary"><?php echo $row['register_id']; ?></span>
          </div>
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Email :</span> <span class="text-secondary"><?php echo $row['email']; ?></span>
          </div>

          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Room :</span> <span class="text-secondary"><?php echo $row['room_type']; ?></span>
          </div>
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Room Type :</span> <span class="text-secondary"><?php echo $row['condition']; ?></span>
          </div>

          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Duration :</span> <span class="text-secondary"><?php echo $row['duration']; ?></span>
          </div>
          <h4 class="text-danger p-2 border-bottom">Address</h4>
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Village :</span> <span class="text-secondary"><?php echo $row['village']; ?></span>
          </div>

          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">City :</span> <span class="text-secondary"><?php echo $row['city']; ?></span>
          </div>
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">State :</span> <span class="text-secondary"><?php echo $row['state']; ?></span>
          </div>

          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Zip :</span> <span class="text-secondary"><?php echo $row['zip']; ?></span>
          </div>

          <h4 class="text-danger p-2 border-bottom">Guardian</h4>
          
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Guardian Name :</span> <span class="text-secondary"><?php echo $row['guardian']; ?></span>
          </div>

          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Guardian relation :</span> <span class="text-secondary"><?php echo $row['grelation']; ?></span>
          </div>
          <div class="col-md-6 py-2 col-12">
          <span class="r text-black">Mobile No. :</span> <span class="text-secondary"><?php echo $row['gmobile']; ?></span>
          </div>
